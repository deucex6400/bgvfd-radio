...
def make_channel_lpf(sample_rate, cutoff_hz, trans_hz):
    taps = firdes.low_pass(1.0, sample_rate, cutoff_hz, trans_hz, firdes.WIN_HAMMING, 6.76)
...
intents.message_content = True  # prefix commands; slash commands don't require this
